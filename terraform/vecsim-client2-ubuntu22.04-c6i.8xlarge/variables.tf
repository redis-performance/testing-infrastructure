...
variable "setup_name" {
  ...
  default     = "vecsim-client2-ubuntu22.04-c6i.8xlarge"
}
...
# (Ubuntu 22.04)
#	Jammy Jellyfish	22.04 LTS	amd64	hvm:ebs-ssd	20240701	ami-003932de22c285676	hvm
variable "instance_ami" {
  description = "AMI for aws EC2 instance - us-east-2 Ubuntu 22.04 LTS 20240701"
