...
variable "setup_name" {
  ...
  default     = "redis-benchmarks-spec-sc-coordinator-arm64-ubuntu24.04-i8g.metal-24xl-nvme-1"
}
...
variable "environment" {
  ...
  default     = "OSS-SPEC-ARM-METAL-NVME"
}
...
# Noble Numbat 24.04 LTS arm64 hvm:ebs-ssd-gp3 20260904
...
variable "platform_name_base" {
  ...
  default     = "arm-aws-i8g.metal-24xl"
}
