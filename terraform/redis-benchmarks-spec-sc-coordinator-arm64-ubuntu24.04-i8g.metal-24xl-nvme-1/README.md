# Storage-qualification coordinator — arm64 / i8g.metal-24xl
...
The x86 counterpart is `redis-benchmarks-spec-sc-coordinator-amd64-ubuntu24.04-i7i.metal-24xl-nvme-1`.
...
|---|---|---|---|
| `nvme` | `/mnt/nvme` | `arm-aws-i8g.metal-24xl-nvme` | EC2 instance store, RAID0 across 6 × 3750 GB |
| `ebs` | `/mnt/ebs` | `arm-aws-i8g.metal-24xl-ebs` | dedicated gp3 volume, IOPS/throughput set in terraform |
