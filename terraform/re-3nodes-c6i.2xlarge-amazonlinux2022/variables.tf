...
variable "setup_name" {
  ...
  default     = "perf-cto-RE-3nodes-c6i.2xlarge-al2022"
}
...
# Amazon Linux 2022 AMI (64-bit x86)
variable "instance_ami" {
  description = "AMI for aws EC2 instance - us-east-2  al2022-ami-minimal-2022.0.20230118.3-kernel-5.15-x86_64"
  default     = "ami-0cccab8631c5cfc01"
}
