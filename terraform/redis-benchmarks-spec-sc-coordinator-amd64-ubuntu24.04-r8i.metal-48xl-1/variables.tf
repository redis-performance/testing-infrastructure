...
variable "setup_name" {
  ...
  default     = "redis-benchmarks-spec-sc-coordinator-amd64-ubuntu24.04-r8i.metal-48xl-1"
}
...
# (Ubuntu 24.04)
# Noble Numbat	24.04 LTS	amd64	hvm:ebs-ssd-gp3	20250731
...
variable "platform_name" {
  ...
  default     = "x86-aws-r8i.metal-48xl"
}
