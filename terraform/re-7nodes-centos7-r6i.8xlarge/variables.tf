...
variable "setup_name" {
  ...
  default     = "perf-cto-RE-7nodes-centos7-redisearch-2.10.0"
}
...
variable "instance_ami" {
  description = "AMI for aws EC2 instance - us-east-2 2022-05-18T17:29:32.000Z 	RHEL-7.9_HVM-20220512-x86_64-1-Hourly2-GP2 	x86_64"
  default     = "ami-0bb2449c2217cb9b0"
}
