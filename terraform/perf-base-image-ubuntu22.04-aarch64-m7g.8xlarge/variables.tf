...
variable "setup_name" {
  ...
  default     = "perf-base-image-ubuntu22.04-aarch64-m7g.8xlarge"
}
...
# (Ubuntu 22.04)
#	Jammy Jellyfish	22.04 LTS	arm64	hvm:ebs-ssd	20250305	ami-068da067c3c4ef0d3	hvm
variable "instance_ami" {
  description = "AMI for aws EC2 instance - us-east-2 Ubuntu 22.04 LTS 20250305"
  default     = "ami-068da067c3c4ef0d3"
}
