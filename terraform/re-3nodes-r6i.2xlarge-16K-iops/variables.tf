...
variable "setup_name" {
  ...
  default     = "perf-cto-RE-3nodes-r6i.2xlarge-v7.2-64K-iops"
}
...
variable "instance_volume_bw" {
  description = "EC2 instance Throughput to provision for a volume in mebibytes per second (MiB/s)"
  default     = "1000"
}
