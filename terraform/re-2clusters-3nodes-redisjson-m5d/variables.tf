...
variable "setup_name" {
  ...
  default     = "perf-cto-RE-2clusters-2nodes-redisjson-m5d"
}
...
################################################################################
# THIS IS PER CLUSTER CONFIG ( meaning for example 3 server_instance_count means 2 cluster with 3 nodes each )
